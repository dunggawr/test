            ...
            <div className="grid lg:grid-cols-2 place-items-center gap-8">          
                <div className="flex relative w-[280px] h-[290px] xl:w-[557px] xl:h-[567px]">
                    <div className="flex absolute top-0 left-0 w-full h-full justify-end items-start mr-2.5">
                        <div className="relative w-[270px] z-[2] h-[270px] lg:w-[530px] lg:h-[530px] rounded-[32px] drop-shadow-2xl overflow-hidden">
                            <Image
                                fill
                    ...
                    <div className="flex absolute top-0 right-0 w-full h-full justify-start items-end mr-2.5">
                        <div className="z-0 w-[270px] h-[270px] lg:w-[530px] lg:h-[530px] bg-[#E5BEBD] rounded-[32px]"></div>
                    </div>
                </div>
