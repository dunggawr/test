    ...
    return (
        <section className="py-[60px] px-[16px] md:px-[80px] bg-[#FDF6EB]">
            <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between">
                ...
                <div className="grid grid-rows-3 grid-cols-3 w-[290px] h-[290px] lg:w-[400px] lg:h-[400px] place-items-center my-8 lg:my-0">
                    ...
                    <div className="w-[85px] h-[85px] md:w-[120px] md:h-[120px] relative">
                        <div className="w-[56.38px] h-[56.38px] md:w-[86.38px] md:h-[86.38px] absolute bg-[#F8EDED] left-[14.07%] top-[15.83%] rounded-[24px]"></div>
