    ...
    return (
        <section className="py-[60px] px-[16px] md:px-[80px] bg-[#FDF6EB]">
            <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between">
                ...
                <div className="grid grid-rows-3 grid-cols-3 w-[310px] h-[310px] lg:w-[400px] lg:h-[400px] place-items-center my-8 lg:my-0">
                    ...
                    <div className="w-[80px] h-[80px] md:w-[120px] md:h-[120px] relative">
