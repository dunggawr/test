        ...
        <section className="py-[60px] px-[16px] md:px-[80px] bg-white">
            <div className="grid lg:grid-cols-2 gap-12 place-items-center">
                ...
                <div className="block lg:hidden">
                    <div className="flex relative w-[280px] h-[280px]">
                        <div className="flex absolute w-full h-full justify-start items-start mr-2.5">
                            <div className="relative w-[180px] z-[2] h-[180px] rounded-[32px] drop-shadow-2xl overflow-hidden">
                                <Image
                                    fill={true}
                                    style={{
                                        objectFit: "cover"
                        ...
                        <div className="flex absolute w-full h-full justify-center items-center mr-2.5">
                            <div className="w-[180px] z-[0] h-[180px] rounded-[32px] bg-[#BE5C59]"></div>
                        </div>

                        <div className="flex absolute w-full h-full justify-end items-end mr-2.5">
                            <div className="relative w-[180px] z-[1] h-[180px] rounded-[32px] drop-shadow-2xl overflow-hidden">
                                <Image
                                    fill={true}
                                    style={{
                                        objectFit: "cover"
